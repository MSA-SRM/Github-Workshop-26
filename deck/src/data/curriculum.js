...
export const GROUPS = [
  ...
  {
    letter: 'B', title: 'Repositories',
    topics: [
      { text: 'Creating a repo', icons: ['repo', 'plus'], tier: 1 },
      { text: 'Repo naming conventions', icons: ['typography'], tier: 1 },
      { text: 'Description, topics, website', icons: ['info', 'tag'], tier: 1 },
      { text: 'Public vs private', icons: ['globe', 'lock'], tier: 1 },
      { text: 'The nine repo tabs', icons: ['repo', 'issue-opened', 'git-pull-request', 'play', 'project', 'book', 'shield', 'graph', 'gear'], tier: 2 },
      { text: 'The Code button', icons: ['code'], tier: 2 },
      { text: 'Repo templates', icons: ['repo-template'], tier: 3 },
      { text: 'Archiving', icons: ['archive'], tier: 3 },
      { text: 'Deleting / transferring', icons: ['trash', 'arrow-switch'], tier: 3 },
      { text: 'Repo settings', icons: ['gear'], tier: 3 },
    ],
  },
  {
    letter: 'C', title: 'Repo furniture',
    topics: [
      { text: 'README.md', icons: ['book'], tier: 1 },
      { text: '.gitignore', icons: ['eye-closed'], tier: 1 },
      { text: 'LICENSE — no licence means not open source', icons: ['law'], tier: 1 },
      { text: 'MIT vs Apache-2.0 vs GPL', icons: ['law'], tier: 3 },
      { text: 'CONTRIBUTING.md', icons: ['checklist'], tier: 3 },
      { text: 'CODE_OF_CONDUCT.md', icons: ['people'], tier: 3 },
      { text: 'CODEOWNERS', icons: ['shield-check'], tier: 3 },
      { text: 'Issue & PR templates', icons: ['note'], tier: 3 },
      { text: '.gitattributes', icons: ['file-code'], tier: 3 },
    ],
  },
  {
    letter: 'D', title: 'Markdown',
    topics: [
      { text: 'Headings', icons: ['heading'], tier: 1 },
      { text: 'Bold / italic', icons: ['bold', 'italic'], tier: 1 },
      { text: 'Lists', icons: ['list-ordered', 'list-unordered'], tier: 1 },
      { text: 'Task lists', icons: ['tasklist'], tier: 1 },
      { text: 'Links & images', icons: ['link', 'image'], tier: 1 },
      { text: 'Code fences', icons: ['code'], tier: 1 },
      { text: 'Blockquotes', icons: ['quote'], tier: 2 },
      { text: 'Tables', icons: ['table'], tier: 3 },
      { text: 'GFM alerts', icons: ['alert'], tier: 3 },
      { text: 'Collapsible details', icons: ['fold'], tier: 3 },
      { text: 'Mermaid diagrams', icons: ['workflow'], tier: 3 },
      { text: 'Emoji shortcodes', icons: ['smiley'], tier: 3 },
    ],
  },
  {
    letter: 'E', title: 'Getting a copy',
    topics: [
      { text: 'Fork', icons: ['repo-forked'], tier: 1 },
      { text: 'Clone', icons: ['repo-clone'], tier: 2 },
      { text: 'Download ZIP', icons: ['download'], tier: 2 },
      { text: 'Use this template', icons: ['repo-template'], tier: 2 },
      { text: 'When to use which', icons: ['git-compare'], tier: 2 },
      { text: 'The "forked from" line', icons: ['repo-forked'], tier: 1 },
      { text: 'Fork network graph', icons: ['graph'], tier: 3 },
    ],
  },
  {
    letter: 'F', title: 'Social & discovery',
    topics: [
      { text: 'Star', icons: ['star'], tier: 2 },
      { text: 'Watch', icons: ['eye'], tier: 2 },
      { text: 'Fork count as a signal', icons: ['repo-forked'], tier: 2 },
      { text: 'Star vs watch vs fork', icons: ['star', 'eye', 'repo-forked'], tier: 2 },
      { text: 'Sponsors', icons: ['heart-fill'], tier: 3 },
      { text: 'Trending & Explore', icons: ['telescope'], tier: 3 },
    ],
  },
  {
    letter: 'G', title: 'Branches',
    topics: [
      { text: 'Creating a branch', icons: ['git-branch'], tier: 1 },
      { text: 'The default branch', icons: ['git-branch'], tier: 2 },
      { text: 'Why we branch', icons: ['git-branch'], tier: 2 },
      { text: 'Branch naming conventions', icons: ['typography'], tier: 1 },
      { text: 'Switching branches', icons: ['arrow-switch'], tier: 1 },
      { text: 'Deleting a merged branch', icons: ['trash'], tier: 2 },
      { text: 'Branch protection rules', icons: ['shield-lock'], tier: 3 },
      { text: 'Branching strategies', icons: ['git-branch'], tier: 3 },
    ],
  },
  {
    letter: 'H', title: 'Commits',
    topics: [
      { text: 'Making a commit', icons: ['git-commit'], tier: 1 },
      { text: 'Commit anatomy', icons: ['git-commit'], tier: 2 },
      { text: 'Atomic commits', icons: ['git-commit'], tier: 2 },
      { text: 'Commit message conventions', icons: ['typography'], tier: 1 },
      { text: 'Conventional Commits', icons: ['checklist'], tier: 2 },
      { text: 'Commit history', icons: ['history'], tier: 2 },
      { text: 'Blame view', icons: ['people'], tier: 2 },
      { text: 'Amending', icons: ['pencil'], tier: 3 },
      { text: 'Signed / Verified commits', icons: ['verified'], tier: 3 },
      { text: 'Reverting', icons: ['arrow-switch'], tier: 3 },
    ],
  },
  {
    letter: 'I', title: 'Pull requests',
    topics: [
      { text: 'Opening a PR', icons: ['git-pull-request'], tier: 1 },
      { text: 'base vs compare', icons: ['arrow-right', 'git-compare'], tier: 1 },
      { text: 'Title & description conventions', icons: ['typography'], tier: 1 },
      { text: 'Conversation / Commits / Files changed', icons: ['comment-discussion', 'git-commit', 'file-diff'], tier: 2 },
      { text: 'The diff view', icons: ['diff-added', 'diff-removed', 'diff-modified'], tier: 2 },
      { text: 'Draft PRs', icons: ['git-pull-request-draft'], tier: 2 },
      { text: 'Open vs merged vs closed', icons: ['git-pull-request', 'git-merge', 'git-pull-request-closed'], tier: 2 },
      { text: 'Reviewers, assignees, labels, milestone', icons: ['person', 'tag', 'milestone', 'project'], tier: 2 },
      { text: 'Linking issues (Closes #12)', icons: ['cross-reference'], tier: 2 },
      { text: '@mentions', icons: ['mention'], tier: 2 },
      { text: 'Reactions', icons: ['smiley'], tier: 3 },
      { text: 'PR templates', icons: ['note'], tier: 3 },
    ],
  },
  {
    letter: 'J', title: 'Code review',
    topics: [
      { text: 'Comment / Approve / Request changes', icons: ['comment', 'check-circle-fill', 'x-circle-fill'], tier: 2 },
      { text: 'Inline comments', icons: ['comment-discussion'], tier: 2 },
      { text: 'Suggested changes', icons: ['code-review'], tier: 2 },
      { text: 'Resolving conversations', icons: ['check'], tier: 2 },
      { text: 'Required reviewers', icons: ['shield-check'], tier: 3 },
      { text: 'Review etiquette', icons: ['people'], tier: 3 },
    ],
  },
  {
    letter: 'K', title: 'Merging',
    topics: [
      { text: 'The merge button', icons: ['git-merge'], tier: 1 },
      { text: 'Merge vs squash vs rebase', icons: ['git-merge', 'fold', 'git-branch'], tier: 2 },
      { text: 'Effect on history', icons: ['history'], tier: 2 },
      { text: 'Status checks', icons: ['dot-fill', 'check-circle-fill', 'x-circle-fill'], tier: 1 },
      { text: 'Required checks', icons: ['shield-check'], tier: 3 },
      { text: 'Merge queue', icons: ['git-merge-queue'], tier: 3 },
    ],
  },
  {
    letter: 'L', title: 'Remotes & syncing',
    topics: [
      { text: 'origin vs upstream', icons: ['repo-forked', 'repo'], tier: 1 },
      { text: '"N commits behind"', icons: ['arrow-down'], tier: 1 },
      { text: 'Sync fork', icons: ['sync'], tier: 1 },
      { text: 'fetch / pull / push / merge', icons: ['repo-pull', 'repo-push', 'git-merge'], tier: 2 },
      { text: 'Sync main before branching', icons: ['north-star'], tier: 2 },
      { text: 'Compare across forks', icons: ['git-compare'], tier: 2 },
      { text: 'CLI equivalents', icons: ['terminal'], tier: 3 },
    ],
  },
  {
    letter: 'M', title: 'Conflicts',
    topics: [
      { text: 'What a conflict is', icons: ['alert'], tier: 1 },
      { text: 'What is not a conflict', icons: ['check-circle'], tier: 2 },
      { text: 'Marker anatomy', icons: ['code'], tier: 1 },
      { text: 'Resolving in the web editor', icons: ['pencil'], tier: 1 },
      { text: 'Mark as resolved → commit merge', icons: ['check', 'git-merge'], tier: 1 },
      { text: 'Preventing conflicts', icons: ['shield'], tier: 2 },
      { text: 'Three-way merge', icons: ['git-compare'], tier: 3 },
      { text: '--ours / --theirs, aborting', icons: ['terminal'], tier: 3 },
    ],
  },
  {
    letter: 'N', title: 'Issues & planning',
    topics: [
      { text: 'Opening an issue', icons: ['issue-opened'], tier: 1 },
      { text: 'Closing / reopening', icons: ['issue-closed', 'issue-reopened'], tier: 2 },
      { text: 'Labels', icons: ['tag'], tier: 2 },
      { text: 'Assignees', icons: ['person'], tier: 2 },
      { text: 'Milestones', icons: ['milestone'], tier: 2 },
      { text: 'Issue templates & forms', icons: ['note'], tier: 3 },
      { text: 'good first issue', icons: ['light-bulb'], tier: 2 },
      { text: 'Projects (boards & tables)', icons: ['project', 'table'], tier: 2 },
      { text: 'Roadmap view', icons: ['project-roadmap'], tier: 3 },
      { text: 'Discussions', icons: ['comment-discussion'], tier: 2 },
      { text: 'Task lists & tracked issues', icons: ['tasklist', 'issue-tracks'], tier: 3 },
    ],
  },
  {
    letter: 'O', title: 'Actions & automation',
    topics: [
      { text: 'What CI/CD means', icons: ['workflow'], tier: 2 },
      { text: 'Watching a run on their own PR', icons: ['play'], tier: 1 },
      { text: 'Reading pass/fail logs', icons: ['log'], tier: 2 },
      { text: 'Workflow file basics', icons: ['file-code'], tier: 3 },
      { text: 'Triggers', icons: ['zap'], tier: 3 },
      { text: 'Marketplace actions', icons: ['package'], tier: 3 },
      { text: 'Secrets in Actions', icons: ['key-asterisk'], tier: 3 },
      { text: 'Bots', icons: ['dependabot', 'hubot'], tier: 2 },
    ],
  },
  {
    letter: 'P', title: 'Pages, releases & packages',
    topics: [
      { text: 'GitHub Pages', icons: ['browser'], tier: 2 },
      { text: 'Tags', icons: ['tag'], tier: 2 },
      { text: 'Releases', icons: ['rocket'], tier: 2 },
      { text: 'Semantic versioning', icons: ['versions'], tier: 3 },
      { text: 'Packages / registry', icons: ['package'], tier: 3 },
      { text: 'Gists', icons: ['logo-gist'], tier: 2 },
    ],
  },
  {
    letter: 'Q', title: 'Security',
    topics: [
      { text: 'Security tab', icons: ['shield'], tier: 2 },
      { text: 'Dependabot', icons: ['dependabot'], tier: 2 },
      { text: 'Secret scanning', icons: ['key'], tier: 2 },
      { text: 'Code scanning', icons: ['codescan'], tier: 3 },
      { text: 'Security advisories', icons: ['shield-x'], tier: 3 },
      { text: 'History is forever — never commit secrets', icons: ['alert-fill'], tier: 2 },
      { text: '2FA & passkeys', icons: ['shield-lock'], tier: 3 },
      { text: 'PATs vs SSH keys', icons: ['key-asterisk'], tier: 3 },
    ],
  },
  {
    letter: 'R', title: 'Insights & analytics',
    topics: [
      { text: 'Insights tab', icons: ['graph'], tier: 2 },
      { text: 'Pulse', icons: ['pulse'], tier: 3 },
      { text: 'Contributors graph', icons: ['people'], tier: 2 },
      { text: 'Traffic', icons: ['meter'], tier: 3 },
      { text: 'Network graph', icons: ['git-branch'], tier: 3 },
    ],
  },
  {
    letter: 'S', title: 'Profile & identity',
    topics: [
      { text: 'Profile README', icons: ['person', 'book'], tier: 2 },
      { text: 'Contribution graph', icons: ['graph'], tier: 2 },
      { text: 'Pinned repositories', icons: ['pin'], tier: 2 },
      { text: 'Achievements', icons: ['trophy'], tier: 3 },
      { text: 'Following people', icons: ['person-add'], tier: 3 },
      { text: 'Contributions as a portfolio', icons: ['briefcase'], tier: 2 },
    ],
  },
  {
    letter: 'T', title: 'Search & navigation',
    topics: [
      { text: 'Repo search & file finder', icons: ['search'], tier: 2 },
      { text: 'Search qualifiers', icons: ['filter'], tier: 2 },
      { text: 'Global code search', icons: ['code-square'], tier: 3 },
      { text: 'Keyboard shortcuts', icons: ['command-palette'], tier: 3 },
      { text: 'Notifications & inbox', icons: ['bell', 'inbox'], tier: 2 },
      { text: 'Managing notification noise', icons: ['bell-slash'], tier: 3 },
    ],
  },
  {
    letter: 'U', title: 'Editors & tooling',
    topics: [
      { text: 'Web editor', icons: ['pencil'], tier: 1 },
      { text: 'github.dev (press .)', icons: ['code-square'], tier: 2 },
      { text: 'Codespaces', icons: ['codespaces'], tier: 2 },
      { text: 'GitHub Desktop', icons: ['desktop-download'], tier: 3 },
      { text: 'GitHub CLI', icons: ['terminal'], tier: 3 },
      { text: 'GitHub Mobile', icons: ['device-mobile'], tier: 3 },
      { text: 'Copilot', icons: ['copilot'], tier: 2 },
    ],
  },
  {
    letter: 'V', title: 'Orgs, teams & permissions',
    topics: [
      { text: "Why you can't push to others' repos", icons: ['lock'], tier: 1 },
      { text: 'Permission levels', icons: ['shield'], tier: 2 },
      { text: 'Collaborators', icons: ['person-add'], tier: 2 },
      { text: 'Organizations', icons: ['organization'], tier: 2 },
      { text: 'Teams', icons: ['people'], tier: 3 },
      { text: 'Visibility in an org', icons: ['globe', 'repo-locked'], tier: 3 },
    ],
  },
  {
    letter: 'W', title: 'Where to go next',
    topics: [
      { text: 'Finding a good first issue', icons: ['light-bulb'], tier: 2 },
      { text: 'Contribution etiquette', icons: ['people'], tier: 3 },
      { text: 'Building a contribution habit', icons: ['flame'], tier: 3 },
      { text: 'GitHub Skills & docs', icons: ['book'], tier: 3 },
      { text: 'Universe & the wider community', icons: ['broadcast'], tier: 3 },
    ],
  },
];
